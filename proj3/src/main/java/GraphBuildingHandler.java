...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public GraphBuildingHandler(GraphDB g) {
        this.g = g;
        currentWay = g.new Way(-1, new ArrayList<>());
        currentNode = g.new Node(-1, -1, -1);
    }
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            currentNode = g.new Node(Long.parseLong(attributes.getValue("id")), Double.parseDouble(attributes.getValue("lon")), Double.parseDouble(attributes.getValue("lat")));
            g.addVertex(currentNode);

        } else if (qName.equals("way")) {
            /* We encountered a new <way...> tag. */
            activeState = "way";
            currentWay = g.new Way(Long.parseLong(attributes.getValue("id")), new ArrayList<>());
//            System.out.println("Beginning a way...");
            ...
            if (k.equals("maxspeed")) {
                currentWay.setMaxSpeed(attributes.getValue(v));
            } else if (k.equals("highway")) {
                currentWay.setValidFlag(ALLOWED_HIGHWAY_TYPES.contains(v));
